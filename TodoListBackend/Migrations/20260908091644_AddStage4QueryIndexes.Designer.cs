...
namespace TodoListBackend.Migrations
{
    ...
    [Migration("20260908091644_AddStage4QueryIndexes")]
    partial class AddStage4QueryIndexes
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TodoListBackend.Models.RefreshTokenSession", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("TodoListBackend.Models.Todo", b =>
                {
                    ...
                    b.HasIndex("UserId", "CategoryId", "IsDeleted")
                        .HasDatabaseName("IX_Todos_UserId_CategoryId_IsDeleted");

                    b.HasIndex("UserId", "IsDeleted", "IsCompleted")
                        .HasDatabaseName("IX_Todos_UserId_IsDeleted_IsCompleted");

                    b.HasIndex("UserId", "IsDeleted", "IsHidden", "DueDate", "Id")
