...
namespace TodoListBackend.Services
{
    ...
    {
        Task<DTOs.PaginatedResponse<TodoResponseDto>> GetAllTodosAsync(int userId, int page = 1, int pageSize = 20, string? filter = null, int? projectId = null, string? status = null, string? sortBy = null);
